...
IMPORTANT: when stating or discussing a Theory, follow `aai_coding.write_prose` closely. A Theory lives in minds, and its statement must be plain enough to hold there.
'''
